...
function printVanillaOptinoFactoryContractDetails() {
  ...
  if (_vanillaOptinoFactoryContractAddress != null && _vanillaOptinoFactoryContractAbi != null) {
    ...
    for (i = 0; i < seriesDataLength; i++) {
        ...
        console.log("RESULT:     .currentSpot/spot=" + optinoTokenContract.currentSpot.call().shift(-18) + "/" + optinoTokenContract.spot.call().shift(-18));
        ...
        console.log("RESULT:     .currentSpot/spot=" + optinoCollateralTokenContract.currentSpot.call().shift(-18) + "/" + optinoCollateralTokenContract.spot.call().shift(-18));
