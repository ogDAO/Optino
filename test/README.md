...
* Geth/v1.8.22-stable-7fa3509e/darwin-amd64/go1.11.5 running with the Byzantium fork switched on
...
* The tests were conducted using bash shell scripts running Geth/v1.8.22-stable-7fa3509e/darwin-amd64/go1.11.5 JavaScript commands
* The smart contracts were compiled using Solidity 0.5.4+commit.9549d8ff.Darwin.appleclang
