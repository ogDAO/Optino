var VANILLAOPTINOFACTORYADDRESS = "0x6eF99cf7Af60e8c65907c8d4B1E7813ADeeB6705";
      ...
      if (!state.executing) {
        ...
        if (networkChanged || blockChanged || coinbaseChanged || paramsChanged) {
          ...
          for (var i = 0; i < seriesDataLength; i++) {
            ...
            var timestamp = series[5];
            var optionToken = series[6];
            var optionCollateralToken = series[7];
