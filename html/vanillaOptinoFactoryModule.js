...
const vanillaOptinoFactoryModule = {
  ...
  mutations: {
    ...
    updateOptinoTokenTemplateAddress(state, optinoTokenTemplate) {
      state.optinoTokenTemplate = optinoTokenTemplate;
      logDebug("vanillaOptinoFactoryModule", "updateOptinoTokenTemplateAddress('" + optinoTokenTemplate + "')")
    },
      ...
      if (!state.executing) {
        ...
        if (networkChanged || blockChanged || coinbaseChanged || paramsChanged) {
          ...
          if (optinoTokenTemplate !== state.optinoTokenTemplate) {
            commit('updateOptinoTokenTemplateAddress', optinoTokenTemplate);
          }
