  ...
  actions: {
    ...
    async execWeb3({ state, commit, rootState }, { count, networkChanged, blockChanged, coinbaseChanged }) {
      ...
      if (!state.executing) {
        ...
        var contract = web3.eth.contract(VANILLAOPTINOABI).at(state.address);
